          ...
          <div className="modern-container">
            <div className="modern-footer__content">
              ...
              <div className="modern-footer__dev" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
                ...
                Contact{' '}
                <a href="mailto:abelghebz@gmail.com" aria-label="Email" style={{ display: 'inline-flex', opacity: 0.5 }}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="2" y="4" width="20" height="16" rx="2" />
                    <path d="M22 4L12 13 2 4" />
                  </svg>
                </a>
                <a href="https://wa.me/447527841324" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" style={{ display: 'inline-flex', opacity: 0.5 }}>
                ...
                <span style={{ opacity: 0.3 }}>·</span>
                Donate{' '}
                <a href="https://ko-fi.com/abeallin" target="_blank" rel="noopener noreferrer" aria-label="Ko-fi" style={{ display: 'inline-flex', opacity: 0.5 }}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
