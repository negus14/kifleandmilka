    ...
    <div className="min-h-screen bg-[#faf1e1] text-[#2d2b25] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[#faf1e1]/80 border-b border-[#2d2b25]/[0.06]">
        <div className="max-w-7xl mx-auto px-6 md:px-10 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="hidden md:inline-block text-[13px] font-['DM_Sans',sans-serif] font-medium tracking-[0.08em] uppercase text-[#2d2b25]/60 hover:text-[#2d2b25] transition-colors px-3 py-2"
            >
              Log In
            </Link>
            <Link
              href="/signup"
              className="hidden md:inline-block text-[13px] font-['DM_Sans',sans-serif] font-medium tracking-[0.08em] uppercase border border-[#2d2b25] px-5 py-2 hover:bg-[#2d2b25] hover:text-[#faf1e1] transition-all duration-300"
            >
              Get Started
            </Link>
            <MobileNav />
      ...
      <section className="relative min-h-screen flex items-center pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-6 items-center min-h-[calc(100vh-4rem)]">
            ...
            <div className="flex flex-col justify-center py-16 lg:py-0">
              <p className="font-['Caveat',cursive] text-lg text-[#b5a992] mb-4 animate-[fadeUp_0.8s_ease_0.1s_both]">
              ...
              <h1 className="font-['Cormorant_Garamond',serif] leading-[0.92] tracking-[-0.02em] mb-8">
                ...
                <span className="block text-[clamp(3rem,7.5vw,6rem)] italic font-light text-[#b5a992] animate-[fadeUp_0.8s_ease_0.5s_both]">
                  in minutes.
                </span>
              </h1>

              <p className="font-['DM_Sans',sans-serif] text-base md:text-lg text-[#2d2b25]/55 max-w-md leading-relaxed mb-10 animate-[fadeUp_0.8s_ease_0.6s_both]">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 animate-[fadeUp_0.8s_ease_0.7s_both]">
                <Link
                  href="/signup"
                  className="group relative inline-flex items-center gap-3 bg-[#2d2b25] text-[#faf1e1] px-8 py-4 font-['DM_Sans',sans-serif] text-[13px] font-semibold tracking-[0.12em] uppercase hover:bg-[#1a1812] transition-colors duration-300 overflow-hidden"
                >
        ...
        <div className="absolute bottom-8 left-1/2 flex flex-col items-center gap-2 animate-[fadeUp_0.8s_ease_1.2s_both]">
          ...
          <div className="w-px h-8 bg-gradient-to-b from-[#2d2b25]/30 to-transparent animate-[breathe_2.5s_ease-in-out_infinite]" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <ScrollReveal stagger={200}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0 relative">
              ...
              <div className="hidden md:block absolute top-1/2 left-[16.67%] right-[16.67%] h-px bg-[#cdc1ab]/30" />
              ...
              {[
                ...
                >
                  <span className="font-['Caveat',cursive] text-5xl md:text-6xl font-bold text-[#cdc1ab]/30 group-hover:text-[#faf1e1]/15 transition-colors duration-500 absolute top-4 right-6">
                    {step.num}
                  </span>
                  <div className="relative">
                    <div className="w-10 h-px bg-[#2d2b25]/20 group-hover:bg-[#faf1e1]/20 mb-8 transition-colors duration-500" />
                    <h3 className="font-['Cormorant_Garamond',serif] text-xl md:text-2xl mb-4 font-medium group-hover:text-[#faf1e1] transition-colors duration-500">
                      {step.title}
                    </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <ScrollReveal className="relative order-2 lg:order-1">
              <div className="relative">
                ...
                <div className="relative bg-white p-3 shadow-[0_20px_60px_rgba(0,0,0,0.06)] animate-[float_8s_ease-in-out_infinite]">
            ...
            <ScrollReveal className="order-1 lg:order-2" stagger={150}>
              ...
              <div className="space-y-8">
                {[
                  ...
                  >
                    <div className="mt-2 w-2 h-2 rotate-45 border border-[#cdc1ab] group-hover:bg-[#cdc1ab] group-hover:rotate-[90deg] transition-all duration-500 shrink-0" />
                    <div>
      ...
      {/* ============ PRICING ============ */}
      <section id="pricing" className="py-24 md:py-36 bg-[#2d2b25]/[0.02]">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <ScrollReveal className="text-center mb-16 md:mb-20">
            ...
            <p className="font-['DM_Sans',sans-serif] text-sm text-[#2d2b25]/50 mt-4 max-w-lg mx-auto leading-relaxed">
          ...
          <ScrollReveal>
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0">
              {/* Free Plan */}
              <div className="bg-white border border-[#2d2b25]/10 p-8 md:p-10 md:rounded-l-sm md:border-r-0 rounded-sm md:rounded-r-none">
                <p className="font-['DM_Sans',sans-serif] text-[11px] font-semibold tracking-[0.2em] uppercase text-[#2d2b25]/40 mb-3">
                  Free
                </p>
                <div className="flex items-baseline gap-1 mb-2">
                  <span className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#2d2b25]">
                    £0
                  </span>
                </div>
                <p className="font-['DM_Sans',sans-serif] text-sm text-[#2d2b25]/45 mb-8">
                ...
                <div className="space-y-4 mb-10">
                  {[
                    ...
                    <div key={item} className="flex items-start gap-3">
                      <svg className="w-4 h-4 mt-0.5 shrink-0 text-[#cdc1ab]" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="font-['DM_Sans',sans-serif] text-sm text-[#2d2b25]/60">
                        {item}
                      </span>
                    </div>
                  ))}
                ...
                <Link
                  href="/signup"
                  className="block text-center py-3.5 font-['DM_Sans',sans-serif] text-[12px] font-semibold tracking-[0.12em] uppercase border border-[#2d2b25]/20 text-[#2d2b25]/70 hover:border-[#2d2b25] hover:text-[#2d2b25] transition-all duration-300 rounded-sm"
                >
                  Start Building
                </Link>
              </div>
              ...
              {/* Premium Plan */}
              <div className="relative bg-[#2d2b25] text-[#faf1e1] p-8 md:p-10 md:rounded-r-sm rounded-sm md:rounded-l-none overflow-hidden">
                {/* Decorative accent */}
                ...
                <div className="relative">
                  <div className="flex items-center gap-3 mb-3">
                    <p className="font-['DM_Sans',sans-serif] text-[11px] font-semibold tracking-[0.2em] uppercase text-[#faf1e1]/50">
                      Premium
                    </p>
                    <span className="font-['DM_Sans',sans-serif] text-[9px] font-bold tracking-[0.15em] uppercase bg-[#cdc1ab]/20 text-[#cdc1ab] px-2 py-0.5 rounded-full">
                      Most Popular
                    </span>
                  </div>
                  <div className="flex items-baseline gap-1 mb-2">
                    <span className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#faf1e1]">
                      £50
                    </span>
                    <span className="font-['DM_Sans',sans-serif] text-sm text-[#faf1e1]/35">
                      one-time
                    </span>
                  </div>
                  <p className="font-['DM_Sans',sans-serif] text-sm text-[#faf1e1]/45 mb-8">
                  ...
                  <div className="space-y-4 mb-10">
                    {[
                      ...
                      <div key={item} className="flex items-start gap-3">
                        ...
                        <span className="font-['DM_Sans',sans-serif] text-sm text-[#faf1e1]/65">
                          {item}
                        </span>
                      </div>
                    ))}
                  ...
                  <Link
                    href="/signup"
                    className="group block text-center py-3.5 font-['DM_Sans',sans-serif] text-[12px] font-semibold tracking-[0.12em] uppercase bg-[#faf1e1] text-[#2d2b25] hover:bg-[#cdc1ab] transition-all duration-300 rounded-sm relative overflow-hidden"
                  >
                  ...
                  <p className="font-['DM_Sans',sans-serif] text-[10px] text-[#faf1e1]/25 text-center mt-4 tracking-wide">
      ...
      <section className="bg-[#2d2b25] py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 w-[400px] h-[400px] rounded-full border border-[#faf1e1]/[0.04] animate-[ringPulse_8s_ease-in-out_infinite]" style={{ transform: "translate(-50%, -50%)" }} />
        <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] rounded-full border border-[#faf1e1]/[0.03] animate-[ringPulse_8s_ease-in-out_2s_infinite]" style={{ transform: "translate(-50%, -50%)" }} />
        <div className="absolute top-1/2 left-1/2 w-[600px] h-[600px] rounded-full border border-[#faf1e1]/[0.02] animate-[ringPulse_8s_ease-in-out_4s_infinite]" style={{ transform: "translate(-50%, -50%)" }} />

        <div className="relative max-w-3xl mx-auto px-6 md:px-10 text-center">
          <ScrollReveal>
            <p className="font-['Caveat',cursive] text-xl text-[#cdc1ab]/70 mb-4">
              Your love story deserves a beautiful home
            </p>
            <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(2.2rem,5.5vw,4rem)] leading-tight text-[#faf1e1] mb-6">
      ...
      {/* ============ FOOTER ============ */}
      <footer className="bg-[#cdc1ab]/20 relative">
        <FlourishDivider />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3 font-['DM_Sans',sans-serif] text-[11px] text-[#2d2b25]/25">
              <span>Created by</span>
                {/* GitHub */}
                <a href="https://github.com/abeallin" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-[#2d2b25]/25 hover:text-[#2d2b25] transition-colors">
                ...
                <span>Contact</span>
                {/* Email */}
                <a href="mailto:abelghebz@gmail.com" aria-label="Email" className="text-[#2d2b25]/25 hover:text-[#2d2b25] transition-colors">
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/447527841324" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-[#2d2b25]/25 hover:text-[#2d2b25] transition-colors">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                <span>Donate</span>
                {/* Ko-fi */}
                <a href="https://ko-fi.com/abeallin" target="_blank" rel="noopener noreferrer" aria-label="Ko-fi" className="text-[#2d2b25]/25 hover:text-[#2d2b25] transition-colors">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
